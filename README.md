A primitive application to detect fraud in a Contact center scenario. Imagine a fraudster calling a contact center to carry out an Account Takeover (ATO). They try to emotionally manipulate the agent and try to gain access. 
